...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch) {
            case COURSES:
                //vnd.android.cursor.dir/vnd.com.example.faitha.notekeeper.courses
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
                        MIME_VENDOR_TYPE + Courses.PATH;
                break;
            case NOTES:
                //vnd.android.cursor.dir/vnd.com.example.faitha.notekeeper.notes
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            case NOTES:
                ...
                //content://com.example.faitha.notekeeper.provider/notes/1
                rowUri = ContentUris.withAppendedId(Notes.CONTENT_URI, rowId);
                break;

            case COURSES:
                rowId = db.insert(CourseInfoEntry.TABLE_NAME, null, values);
                //content://com.example.faitha.notekeeper.provider/courses/1
